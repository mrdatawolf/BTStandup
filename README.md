...
Completed entries offer a shortcut to a new ERPNext Issue and pass the entry
title into its Subject field. Override `ISSUE_CREATE_URL` in `.env` if the
ERPNext new-issue page moves.
